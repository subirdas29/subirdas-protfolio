...
const About = () => {
	...
	<div className="flex justify-center pt-4 space-x-4 align-center">
		...
		<a rel="noopener noreferrer" href="#" aria-label="Dribble" className="p-2 rounded-md hover:dark:text-violet-400">
		...
		<a rel="noopener noreferrer" href="#" aria-label="Twitter" className="p-2 rounded-md  hover:dark:text-violet-400">
			<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
		...
		<a rel="noopener noreferrer" href="#" aria-label="Email" className="p-2 rounded-md  hover:dark:text-violet-400">
			<svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-current">
